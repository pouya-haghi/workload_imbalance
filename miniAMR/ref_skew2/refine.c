...
void refine(int ts)
{
   ...
   MPI_Allreduce(local_num_blocks, num_blocks, (num_refine+1),
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Allreduce-16: time: %lf \n", t_latency);
    fclose(outfile);
   ...
   for (i = 0; i < num_refine_step; i++) {
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Allreduce-17: time: %lf \n", t_latency);
    fclose(outfile);
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Allreduce-18: time: %lf \n", t_latency);
    fclose(outfile);
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Allreduce-19: time: %lf \n", t_latency);
    fclose(outfile);
      timer_refine_sy += timer() - t2;
      t4 += timer() - t2;
      if (lb_opt == 2) {
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Allreduce-20: time: %lf \n", t_latency);
    fclose(outfile);
    t_start = MPI_Wtime(); //added
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Allreduce-21: time: %lf \n", t_latency);
    fclose(outfile);
    t_start = MPI_Wtime(); //added
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Allreduce-22: time: %lf \n", t_latency);
    fclose(outfile);
         t4 += timer() - t2;
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Allreduce-23: time: %lf \n", t_latency);
    fclose(outfile);
            timer_refine_sy += timer() - t2;
            t4 += timer() - t2;
         }
   ...
   MPI_Allreduce(&num_active, &min_b, 1, MPI_INT, MPI_MIN, MPI_COMM_WORLD);
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Allreduce-24: time: %lf \n", t_latency);
    fclose(outfile);
    t_start = MPI_Wtime(); //added
   MPI_Allreduce(&num_active, &max_b, 1, MPI_INT, MPI_MAX, MPI_COMM_WORLD);
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Allreduce-25: time: %lf \n", t_latency);
    fclose(outfile);
    t_start = MPI_Wtime(); //added
   MPI_Allreduce(&num_active, &sum_b, 1, MPI_INT, MPI_SUM, MPI_COMM_WORLD);
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Allreduce-26: time: %lf \n", t_latency);
    fclose(outfile);
   i = nm_r + nm_c;
    t_start = MPI_Wtime(); //added
   MPI_Allreduce(&i, &num_split, 1, MPI_INT, MPI_SUM, MPI_COMM_WORLD);
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Allreduce-27: time: %lf \n", t_latency);
    fclose(outfile);
   ...
   if (lb_opt) {
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Allreduce-28: time: %lf \n", t_latency);
    fclose(outfile);
    t_start = MPI_Wtime(); //added
         MPI_Allreduce(&num_active, &max_b, 1, MPI_INT, MPI_MAX,
                       MPI_COMM_WORLD);
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Allreduce-29: time: %lf \n", t_latency);
    fclose(outfile);
    t_start = MPI_Wtime(); //added
         MPI_Allreduce(&num_active, &sum_b, 1, MPI_INT, MPI_SUM,
                       MPI_COMM_WORLD);
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Allreduce-30: time: %lf \n", t_latency);
    fclose(outfile);
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Allreduce-31: time: %lf \n", t_latency);
    fclose(outfile);
         timer_refine_sy += timer() - t2;
         t4 += timer() - t2;
      }
   ...
   MPI_Allreduce(nc, ncn, 5, MPI_INT, MPI_MIN, MPI_COMM_WORLD);
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Allreduce-32: time: %lf \n", t_latency);
    fclose(outfile);
    t_start = MPI_Wtime(); //added
   MPI_Allreduce(nc, ncx, 5, MPI_INT, MPI_MAX, MPI_COMM_WORLD);
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Allreduce-33: time: %lf \n", t_latency);
    fclose(outfile);
    t_start = MPI_Wtime(); //added
   MPI_Allreduce(nc, nca, 5, MPI_INT, MPI_SUM, MPI_COMM_WORLD);
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Allreduce-34: time: %lf \n", t_latency);
    fclose(outfile);
   if (!my_pe && report_perf & 8) {
...
// get list of neighbor blocks (indirect links in from blocks)
   ...
   for (level = cur_max_level; level >= 0; level--) {
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Allreduce-35: time: %lf \n", t_latency);
    fclose(outfile);
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Allreduce-36: time: %lf \n", t_latency);
    fclose(outfile);
                         ...
                         int *num_moved, int num_split)
{
   ...
   MPI_Allreduce(bin, gbin, num_pes, MPI_INT, MPI_SUM, MPI_COMM_WORLD);
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Allreduce-37: time: %lf \n", t_latency);
    fclose(outfile);
   ...
   MPI_Allreduce(bin, space, num_pes, MPI_INT, MPI_SUM, MPI_COMM_WORLD);
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Allreduce-38: time: %lf \n", t_latency);
    fclose(outfile);
   ...
   MPI_Allreduce(&m, &n, 1, MPI_INT, MPI_SUM, MPI_COMM_WORLD);
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Allreduce-39: time: %lf \n", t_latency);
    fclose(outfile);
   ...
   if (n) {
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Allreduce-40: time: %lf \n", t_latency);
    fclose(outfile);
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Allreduce-41: time: %lf \n", t_latency);
    fclose(outfile);
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Alltoall-3: time: %lf \n", t_latency);
    fclose(outfile);
