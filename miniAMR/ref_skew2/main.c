...
#include "param.h"
   ...
   if (!my_pe) {
    ...
    fprintf(outfile, "MPI_Bcast-1: time: %lf \n", t_latency);
    fclose(outfile);
      if (use_time)
    t_start = MPI_Wtime(); //added
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Bcast-2: time: %lf \n", t_latency);
    fclose(outfile);
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Bcast-3: time: %lf \n", t_latency);
    fclose(outfile);
      free(objs);
   } else {
    t_start = MPI_Wtime(); //added
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Bcast-4: time: %lf \n", t_latency);
    fclose(outfile);
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Bcast-5: time: %lf \n", t_latency);
    fclose(outfile);
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Bcast-6: time: %lf \n", t_latency);
    fclose(outfile);
   ...
   MPI_Barrier(MPI_COMM_WORLD);
    ...
    snprintf(my_str, sizeof(my_str), "/scratch/07431/tg867305/process_skew/miniamr/%d/p%d.txt", world_size, my_rank);
    outfile = fopen(my_str, "a");
    fprintf(outfile, "MPI_Barrier-1: time: %lf \n", t_latency);
    fclose(outfile);
